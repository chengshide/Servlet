   ...
   <form action="servlet/RegServlet" name="regForm" method="post">
     <table border="0" width="800" cellspacing="0" cellpadding="0">
       ...
       <tr>
         ...
         <td calss="controler"><input type="text" name="birthday" id="control_date" size="10" maxlength="10" onclick="new Calendar().show(this);" readonly="readonly" /></td>
       </tr>
       <tr>
       ...
       <tr>
         ...
         <td class="controler"><input type="checkbox" name="flag" value="true" />是否接受霸王条款</td>
       </tr>
       <tr>
